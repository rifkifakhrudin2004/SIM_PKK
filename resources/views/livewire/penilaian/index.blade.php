					...
					<table class="min-w-full leading-normal">
						<thead>
							<tr>
								...
								@endforeach
								<th class="px-5 py-3 border-b-2 border-gray-200 bg-gray-900 text-white text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">nilai</th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
									<div class="flex items-center justify-center gap-4">
										...
										<x-button-link href="{{ route('penilaian.edit', $alt->id) }}">Input</x-button-link>
									</div>
								</td>
							</tr>
